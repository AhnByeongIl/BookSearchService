<div class="d-flex fixed-top align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
    ...
    <div id="accountArea">
        <a id="login" class="btn btn-outline-primary" style="margin-right:5px;" href="/account/login">Log in</a>
        <a id="logout" class="btn btn-outline-primary" style="margin-right:5px; display:none;" href="/account/login">Log out</a>
